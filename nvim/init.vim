...
" Adjacent duplicate words   //显示相邻相同的字符
...
noremap <a-h> :res +5<CR>
noremap <a-l> :res -5<CR>
...
Plug 'yuezk/vim-js', { 'for': ['vim-plug', 'tmpl','php', 'html', 'javascript', 'css', 'less'] }
...
" Plug 'theniceboy/antovim' " gs to switch 反义词
...
" ga, or :Tabularize <regex> to align 选择一段文字 根据某个符号对齐
...
" TODO: Something  <2021-06-20->Sunday 19:18, MicSama> "
...
" === eleline.vim
" ===
let g:aneirline_powerline_fonts = 0
...
require'nvim-treesitter.configs'.setup {
  ensure_installed = {"go"},     -- one of "all", "language", or a list of languages
